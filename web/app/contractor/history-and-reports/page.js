...
export default function Page() {
    ...
    const handleTrack = () => { console.log("Track", selectedAccount); handleCloseMenu(); };
    const handleContact = () => { console.log("Contact", selectedAccount); handleCloseMenu(); };
    const handleRefresh = () => { console.log("Refreshed!"); setFromDate(null); setToDate(null); };
