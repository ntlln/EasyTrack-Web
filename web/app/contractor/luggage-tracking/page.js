...
export default function Page() {
  ...
  // Load Google Maps script only when contract is found
  useEffect(() => {
  ...
  const initMap = () => {
    ...
    try {
      ...
      // Add initial current location marker if coordinates exist
