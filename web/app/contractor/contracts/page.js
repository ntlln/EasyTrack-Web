            ...
            {!itemCount ? (
                ...
                >
                    <Typography variant="h6" mb={2}>
                        How many items do you want to contract?
                    </Typography>
                    <TextField
                        type="number"
                        value={inputValue}
                        ...
                        sx={{ mb: 2 }}
                    />
                    <Button variant="contained" onClick={handleCountSubmit}>
                        Proceed
                    </Button>
                </Paper>
            ) : (
                <Box>
                    {contracts.map((contract, index) => (
                        ...
                        >
                            ...
                            <Box display="flex" flexDirection="column" gap={2} mb={2}>
                                ...
                                />
                                <TextField
                                    label="Luggage Information"
                                    fullWidth
                                    size="small"
                                    value={contract.luggage}
                                    onChange={(e) => handleInputChange(index, "luggage", e.target.value)}
                                />
                                <TextField
                                    label="House/ Unit/ Bldg No./ Street/ Barangay"
                                    fullWidth
                                    size="small"
                                ...
                                <Box>
                                    ...
                                    {contract.image && (
                                        <Typography variant="body2" mt={1}>
                                            Selected file: {contract.image.name}
                                        </Typography>
                                    )}
                                </Box>
                            </Box>
                    ...
                    <Box display="flex" justifyContent="center" mt={4} gap={2}>
                        <Button variant="outlined" onClick={addContract}>
                            Add Another Form
                        </Button>
