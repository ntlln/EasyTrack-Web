                    ...
                    {conversations.map((c, index) => (
                        <Paper key={index} sx={{ p: 1.5, display: "flex", alignItems: "center", gap: 1, borderRadius: 2, bgcolor: theme.palette.background.default }}>
                            ...
                            <Box sx={{ textAlign: "right" }}>
                                ...
                                {c.unread > 0 && (
                                    <Box sx={{ bgcolor: "primary.main", color: "white", borderRadius: "50%", width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", mx: "auto" }}>
                                        {c.unread}
                                    </Box>
                                )}
                            </Box>
