...
export default function Page() {
    ...
    // Message handlers
    const handleSend = () => { console.log("Message sent:", message); setMessage(""); };

    // Styles
    const mainContainerStyles = { position: "absolute", top: 0, left: "280px", right: 0, bottom: 0, display: "flex", bgcolor: theme.palette.background.default };
    ...
    const messageBubbleStyles = { alignSelf: "flex-start", bgcolor: theme.palette.background.paper, p: 2, borderRadius: 2, maxWidth: "70%" };
    const responseBubbleStyles = { alignSelf: "flex-end", bgcolor: isDark ? "#4d664d" : "#D0E8D0", p: 2, borderRadius: 2, maxWidth: "70%" };
