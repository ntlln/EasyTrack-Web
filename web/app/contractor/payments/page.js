...
export default function PaymentsPage() {
    ...
    const handlePay = () => {
        router.push("/contractor/payments/payment-frame");
    };
        ...
        <Box p={0}>
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                <TextField
                    ...
                    sx={{ borderRadius: "10px", width: 320, boxShadow: 1 }}
                />
                ...
                <Box display="flex" gap={2}>
                    <Button
                        ...
                        onClick={handlePay}
                        sx={{ textTransform: "none", px: 2, py: 1, fontSize: 14 }}
                    >
                        Pay
                    </Button>
                    ...
                    <IconButton
                        ...
                        sx={{ bgcolor: "#4a4a4a", color: "#fff", borderRadius: "5px", px: 2, py: 1, fontSize: 14, "&:hover": { bgcolor: "#333" } }}
                    >
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center" px={1} py={3}>
                <Typography variant="body2">
                    Showing {page * rowsPerPage + 1} - {Math.min((page + 1) * rowsPerPage, transactions.length)} of {transactions.length} completed deliveries
                </Typography>
