...
import { Box, Grid, CardContent, Typography, Button, Avatar, Paper } from '@mui/material';
...
export default function ProfilePage() {
    ...
    return (
        <Box sx={{ maxWidth: '1200px', margin: '0 auto', p: { xs: 2, md: 4 } }}>
            ...
            {/* Profile Card */}
            <Paper elevation={3} sx={{ mb: 4, borderRadius: 2, background: 'linear-gradient(145deg, #ffffff 0%, #f5f5f5 100%)' }}>
                <CardContent sx={{ p: 4 }}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                    <Paper elevation={2} sx={{ height: '100%', borderRadius: 2, transition: 'transform 0.2s', '&:hover': { transform: 'translateY(-4px)' } }}>
                        <CardContent sx={{ p: 3 }}>
            ...
            <Box display="flex" gap={2} mt={4} flexWrap="wrap" justifyContent="center">
                <Button variant="contained" sx={{ borderRadius: 2, textTransform: 'none', px: 4, py: 1 }}>Show Credentials</Button>
