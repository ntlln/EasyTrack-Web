      ...
      <Box>
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>
              {deliveries.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((delivery) => (
                <TableRow key={delivery.id}>
                  ...
                  <TableCell><IconButton onClick={(event) => handleOpenMenu(event, delivery)}><MoreVertIcon /></IconButton></TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
