...
export default function Page() {
  ...
  const cards = [
    { title: "Profile", route: "/contractor/profile", icon: AccountCircleIcon, requiresVerification: false },
    { title: "Booking", route: "/contractor/booking", icon: LocalShippingIcon, requiresVerification: true },
    // { title: "Delivery History & Reports", route: "/contractor/history-and-reports", icon: AssignmentIcon },
    { title: "Luggage Tracking", route: "/contractor/luggage-tracking", icon: MyLocationIcon, requiresVerification: false },
    // { title: "Statistics", route: "/contractor/statistics", icon: BarChartIcon },
    { title: "Message Center", route: "/contractor/chat-support", icon: SupportAgentIcon, requiresVerification: false },
