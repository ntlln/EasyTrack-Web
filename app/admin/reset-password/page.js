...
export default function Page() {
  ...
  const containerStyles = { 
    ...
    backgroundImage: "url(/login-bg.png)", backgroundSize: "80%", backgroundRepeat: "no-repeat", 
    backgroundPosition: "center", backgroundopacity: "30%", overflow: "hidden", position: "fixed", top: 0, left: 0 
  };
  const formContainerStyles = { 
    display: "flex", flexDirection: "column", width: "50vh", height: "auto", 
    backgroundColor: "background.default", boxShadow: 5, borderRadius: 3, 
    alignItems: "center", pt: 5, pb: 5, gap: 2 
  };
        ...
        <Box sx={formContainerStyles}>
          ...
          <form onSubmit={handleSubmit} style={formStyles}>
            ...
            <Button type="submit" variant="contained" color="primary" sx={buttonStyles} disabled={isLoading}>
              {isLoading ? <CircularProgress size={24} sx={{ color: "primary.main" }} /> : "Reset Password"}
            </Button>
          </form>
        </Box>
      </Box>
