...
export default function Page() {
  ...
  const cards = [
    { title: "Profile", route: "/egc-admin/profile", icon: AccountCircleIcon, requiresVerification: false },
    { title: "User Management", route: "/egc-admin/user-management", icon: GroupsIcon, requiresVerification: true },
    { title: "Luggage Tracking", route: "/egc-admin/luggage-tracking", icon: LocationOnIcon, requiresVerification: false },
    { title: "Luggage Management", route: "/egc-admin/luggage-management", icon: MyLocationIcon, requiresVerification: true },
    { title: "Transaction Management", route: "/egc-admin/transaction-management", icon: AssignmentIcon, requiresVerification: true },
    { title: "Statistics", route: "/egc-admin/statistics", icon: BarChartIcon, requiresVerification: false },
    { title: "Chat Support", route: "/egc-admin/chat-support", icon: SupportAgentIcon, requiresVerification: false },
    { title: "System Logs", route: "/egc-admin/logs", icon: HistoryIcon, requiresVerification: false },
  ];
