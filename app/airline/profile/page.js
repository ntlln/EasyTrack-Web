...
export default function Page() {
    ...
    const handleResetPassword = async () => {
        ...
        try {
            ...
            const redirectUrl = isProduction 
                ...
                : `${window.location.origin}/airline/profile/reset-password`;
    ...
    return (
        <Box sx={containerStyles}>
            <Box sx={headerStyles}>
                <IconButton onClick={() => router.push("/airline/")} sx={{ color: "primary.main" }}><ChevronLeftIcon /></IconButton>
                ...
                <CardContent sx={profileContentStyles}>
                    <Box sx={profileHeaderStyles}>
                        ...
                        <Box display="flex" flexDirection="column" gap={2}>
                            <Button variant="contained" onClick={() => router.push('/airline/profile/edit-profile')} sx={buttonStyles}>Edit Profile</Button>
